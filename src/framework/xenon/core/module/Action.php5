<?php
/**
 *	Abstract generic action handler.
 *
 ...
 *	@extends		Framework_Xenon_Core_Component
 ...
 *	@version		0.6
 */
abstract class Framework_Xenon_Core_Module_Action extends Framework_Xenon_Core_Module_Component
{
