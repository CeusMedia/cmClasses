 ...
 *	@version		0.1
 */
class Framework_Xenon_View_Interface extends Framework_Xenon_Core_View
{
	...
	{
		import( 'de.ceus-media.framework.xenon.view.component.DevCenter' );
		$view	= new Framework_Xenon_View_Component_DevCenter();
	...
	{
		import( 'de.ceus-media.framework.xenon.view.component.Navigation' );
		$navigation	= new Framework_Xenon_View_Component_Navigation();
