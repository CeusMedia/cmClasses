 ...
 *	@version		$Id$
 */
class UI_HTML_Element_List_Definition_Term extends UI_HTML_Element_Abstract
{
	/**
	 *	Constructor.
	 *	@access		public
    ...
    public function render()
    {
    	...
    	return $this->renderTag( 'dt', $this->renderContent(), $attributes );
    }
}
?>
