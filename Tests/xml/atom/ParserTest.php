 ...
 *	@version		0.1
 */
class Tests_XML_Atom_ParserTest extends PHPUnit_Framework_TestCase
{
	/**
	 *	Constructor.
	 *	@access		public
	...
	{
		$parser	= new Tests_XML_Atom_ParserInstance;
...
class Tests_XML_Atom_ParserInstance extends XML_Atom_Parser
{
