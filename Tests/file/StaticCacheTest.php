 ...
 *	@version		0.1
 */
class Tests_File_StaticCacheTest extends PHPUnit_Framework_TestCase
{
	/**
	 *	Constructor.
	 *	@access		public
	...
	{
		Tests_MockAntiProtection::createMockClass( 'File_StaticCache' );
	...
	{
		Tests_File_StaticCache_MockAntiProtection::init( $this->pathCache );
		$assertion	= 'File_Cache';
		$creation	= get_class( Tests_File_StaticCache_MockAntiProtection::getProtectedStaticVar( 'store' ) );
		$this->assertEquals( $assertion, $creation );
	}
	...
	{
		Tests_File_StaticCache_MockAntiProtection::init( $this->pathCache );
		Tests_File_StaticCache_MockAntiProtection::set( 'testKey', "testValue" );

		$store		= Tests_File_StaticCache_MockAntiProtection::getProtectedStaticVar( 'store' );
