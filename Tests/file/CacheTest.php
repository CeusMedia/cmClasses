 ...
 *	@version		0.1
 */
class Tests_File_CacheTest extends PHPUnit_Framework_TestCase
{
	/**
	 *	Constructor.
	 *	@access		public
	...
	{
		Tests_MockAntiProtection::createMockClass( 'File_Cache' );
	...
	{
		$mock		= new Tests_File_Cache_MockAntiProtection( $this->pathCache );
	...
	public function test__construct2()
	{
		...
		$mock		= new Tests_File_Cache_MockAntiProtection( $path );
		$assertion	= $this->pathCache;
		$creation	= $mock->getProtectedVar( 'path' );
		$this->assertEquals( $assertion, $creation );
	}
