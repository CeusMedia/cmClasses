 ...
 *	@version		0.1
 */
class Tests_Alg_Parcel_FactoryTest extends PHPUnit_Framework_TestCase
{
	/**
	 *	Constructor.
	 *	@access		public
	...
	{
		$factory	= new Tests_Alg_Parcel_FactoryInstance( $this->packets, $this->articles, $this->volumes );
...
class Tests_Alg_Parcel_FactoryInstance extends Alg_Parcel_Factory
{
