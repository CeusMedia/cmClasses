 ...
 *	@version		0.1
 */
final class Tests_Framework_Krypton_View_Component_TemplateTest extends PHPUnit_Framework_TestCase
{
	protected $path;
	protected $registry;
	...
	{
		$template	= new Tests_Framework_Krypton_View_Component_TemplateInstance( "template" );
		$assertion	= "template";
	...
	public function testSetTemplateException()
	{
		...
		$template	= new Tests_Framework_Krypton_View_Component_TemplateInstance( "not_existing" );
	}		
}
class Tests_Framework_Krypton_View_Component_TemplateInstance extends Framework_Krypton_View_Component_Template
{
