<?php
/**
 *	TestUnit of DefinitionView
 *	@package		tests.framework.krypton.core
 *	@extends		PHPUnit_Framework_TestCase
 *	@uses			Framework_Krypton_Core_DefinitionView
 ...
 *	@version		0.1
 */
class Tests_Framework_Krypton_Core_DefinitionViewTest extends PHPUnit_Framework_TestCase
{
